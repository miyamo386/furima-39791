class OrderAddress
  ...
  def save
    ...
    Address.create(postcode: postcode, prefecture_id: prefecture_id, city: city, block: block, building: building, phone_number: phone_number, user_id: user_id, item_id: item_id)
  end
end